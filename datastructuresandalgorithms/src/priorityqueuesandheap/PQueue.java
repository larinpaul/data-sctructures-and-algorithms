...
//		
//		// Linear scan to check containmen, O(n)
//		// for (int i = 0; i < heapSize; i++)
...
//			if ( left >= heapSize || less(k, smallest)) breakl
//			
...
//		
//		// New value being insserted in map
//		if (set == null) {
//			
//			set = new TreeSet<>();
//			set.add(index);
