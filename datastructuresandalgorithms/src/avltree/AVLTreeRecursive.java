...
//		T value;
//		
//		// The height of this node in tree.
//		int height;
//		
...
//	// root and its furthest leaft. This means that a tree containing a single
...
//	}
//	
//	// Print a visual representation of the tree to the console.
//	public void display() {
...
//		
//		int cmp = elem.compateTo(node.value);
//		
...
////		stack.push(root);
////		
////		return new java.util.Iterator<T> iterator () {
////			
////			final int expectedNodeCount = nodeCount;
////			final java.util.Stack<Node> stack = new java.util.Stack<>();
////			stack.push(root);
...
//	boolean validteBSTInvarien(Node node) {
