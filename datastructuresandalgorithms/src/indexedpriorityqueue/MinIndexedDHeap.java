 ...
 * you have and then use mapping with this indexed priority queue.
 * 
...
public class MinIndexedDHeap <T extends Comparable<T>> {
	...
	// The Inverse Map (im) stored the indexes of the keys in the range
	// [0, sz) which make up the priority queue. It should be nored that
	// 'im' and 'pm' are inverses of each other, so: pm[im[i]] = im[pm[i]] = i
	public final int[] im;
	
	// The values assocaited with the keys. It is very important to node
